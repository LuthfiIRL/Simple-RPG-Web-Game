...
const locations = [
    ...
    },
    {
        ...
        text: "You have entered the almighty store."
    },
    {
        name: "cave",
        "button text": ["Fight slime", "Fight fanged beast", "Go to Townsquare"],
        "button functions": [fightSlime, fightBeast, goTown],
        text: "You decide to enter the cave. Inside the cave you see some monsters."
    },
    {
        name: "fight",
    ...
    },
    {
        ...
        text: "You have defeated the monster. You gain experience and golds!"
    },
    {
        name: "lose",
    ...
    },
    {
        ...
        "button text": ["REPLAY?", "REPLAY?", "REPLAY?"],
        "button functions": [restart, restart, restart],
        text: "You have defetaed the Dragon. You win the game! Congratulation"
    },
    {
        name: "easter egg",
        "button text": ["2", "7", "Go to town square"],
        "button functions": [pickTwo, pickSeven, goTown],
        text: "You have triggered a gambler event. Pick a number above, ten numbers will be randomly chosen between 1 to 10. If the number you choose matches one of them, you win!"
    }        
];
...
function dodge() 
{
    text.innerText = "You dodge an attack from the " + monster[fighting].name + "!";
...
function pick(guess)
{
    ...
    if (numbers.indexOf(guess) !== -1) {
        text.innerText += "Right! you just win 20 golds!";
        gold += 20;
        goldText.innerText = gold;                
    }
    else
    {
        text.innerText += "Wrong! you just lose 10 health!";
        health -= 10;
        healthText.innerText = health;
        if (health <= 0)
        {
